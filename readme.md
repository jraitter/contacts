...
#### Visualization
done - The add contact form can be shown or hidden when necessary
done - Contacts marked as Emergency Contact must be easily distiguished
done - A custom Google Font must be added
done - Contacts are visible when the page reloads

#### Functionality 
done - Add Contact form clears when submitted
done - Add Contact form submission does not reload the page 
done - Contacts are stored in local storage. 
